...
class OverlayLayer extends Layer {
  ...
  init() {
    ...
    this.legend && this.legend.hover(lastIndex);
    if(this.hoverCallback && typeof this.hoverCallback == 'function'){
      this.hoverCallback(lastIndex);
    }
    ...
    function handleTouchMove(){
      ...
      that.legend && that.legend.hover(index);

      //check type
      if(that.hoverCallback && typeof that.hoverCallback == 'function'){
        that.hoverCallback(index)
      }
    }
