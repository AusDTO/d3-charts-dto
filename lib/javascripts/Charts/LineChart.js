...
class LineChart extends Chart {
    ...
    this.svg
        ...
        .each(function(_data) {
          ...
          group.append('path')
               ...
               .attr('stroke', d=> this.isHighContrastMode ? d[0].altColor : d[0].color);
          ...
          group.each(function() {
            ...
            .attr('stroke', d=> this.isHighContrastMode ? d.altColor : d.color);
          });
        });
    this.render();
  }
  ...
  switchColorMode(isHighContrastMode) {
    ...
    if(isHighContrastMode === true){
      this.svg.selectAll('.line')
        .attr('stroke', d=> d[0].altColor);
      this.svg.selectAll('.circle')
          .attr('fill', d=>d.altColor)
          .attr('stroke', d=>d.altColor);
    }
  }
}
